     ...
     Tween:Play()
      ...
      Tween2:Play()
       ...
       pcall(function()
        ...
        print("S Settings:", Entity.Name, Entity.Value)
        end
    end
...
local Killaura = CreateToggle({
    ...
    repeat
        ...
        for _, enemyPlayer in pairs(game:GetService("Players"):GetPlayers()) do
            if enemyPlayer ~= LocalPlayer and enemyPlayer.Team ~= LocalPlayer.Team and IsAlive(enemyPlayer) and GetMatchState() ~= 0 and IsAlive(LocalPlayer) and not enemyPlayer.Character:FindFirstChildOfClass("ForceField") then
